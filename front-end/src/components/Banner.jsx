...
const Banner = ({query, handleInputChange}) => {
    return (
        <div className="max-w-scree-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
                ...
                <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
                    <div className="flex md:rounded-s-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full">
                        <input
                            ...
                            value={query}
                            placeholder="What positions your are looking for ?"
                    ...
                    <div className="flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full">
                        <input
                            type="text"
                            name="location"
                            id="location"
                    ...
                    <button type="submit" className="bg-blue-500 px-8 text-white md:rounded-s-none rounded">Search</button>
                </div>
            </form>
        </div>
    );
