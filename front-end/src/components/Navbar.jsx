...
import { FaBarsStaggered, FaClosedCaptioning, FaXmark } from "react-icons/fa6";
...
const Navbar = () => {
    ...
    const navItems = [
        ...
        { path: "/salary", title: "Salary Esitmate" },
    ...
    return (
        <header className="max-w-screen-2xl container mx-auto xl:px 24 px-4">
            <nav className="flex justify-between items-center py-6">
                ...
                <div className="text-base text-primary  gap-2 hidden lg:flex">
